...
const CodingResources = () => {
  ...
  return (
    <div className="content-header">
      ...
      <p>
        Unlock a treasure trove of knowledge with Algocraft's "Coding Resources"
        – your ultimate destination for a diverse array of coding materials.
        This feature caters to your learning needs by consolidating valuable
        resources from various platforms, offering a seamless and comprehensive
        learning experience.
      </p>
