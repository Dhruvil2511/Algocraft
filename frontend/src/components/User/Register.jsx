...
const Register = () => {
    return (
        <>  <form className="form mt-2">
            ...
            <button className="grad-btn w-100"> <div className="hoverEffect "><div className='w-100'></div></div>Sign Up</button>
            <p className="p">Have an account? <a href="login" className="span">Sign In</a>
