    ...
    return (
        <>
            <form className="form mt-2">
                ...
                <button className="grad-btn w-100"> <div className="hoverEffect "><div className='w-100'></div></div>Sign In</button>
                <p className="p">Don't have an account? <a href="register" className="span">Sign Up</a>

                </p><p className="p line">Or With</p>

                <div className="flex-row">
                    <button className="btn google">
                        <svg version="1.1" width="20" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" >
